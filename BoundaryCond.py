...
if FILE :
    ...
    Param={}
    if ALICE :
        Param["Z_top"                 ]=[ "Average(Position.z,['w_top'],Weight =None)",'',"Z_top"           , ''                          ]  
        Param["Z_ft"                  ]=[ "Average(Position.z,['ft_hp'],Weight =None)",'',"Z_ft"            , ''                          ]  
        Param["X_ft"                  ]=[ "Average(Position.x,['ft_hp'],Weight =None)",'',"X_ft"            , ''                          ]  
        Param["Y_f"                   ]=[ "Average(Position.y,['w_front'],Weight =None)",'',"Y_f"           , ''                          ]  
        ...
        Param["mdot_oxid_staged"      ]=[ f'{MO_bs*fac*0.5:.12e}', ' [%s]'%(unit) , "mdot_oxid_staged"      , 'mass-flow'                 ]
        Param["mdot_oxid_top"         ]=[ f'{MO_t *fac   :.12e}' , ' [%s]'%(unit) , "mdot_oxid_top"         , 'mass-flow'                 ]
        Param["mdot_oxid_bot"         ]=[ f'{MO_bc*fac   :.12e}' , ' [%s]'%(unit) , "mdot_oxid_bottom"      , 'mass-flow'                 ]
        ...
        Param["eps_rf"                ]=[ f'{eps_rf      :.2f}'  , ''             , "eps_rf"                , ''                          ]
        Param["eps_ss"                ]=[ f'{eps_ss      :.2f}'  , ''             , "eps_ss"                , ''                          ]
        Param["eps_cb"                ]=[ f'{eps_cb      :.2f}'  , ''             , "eps_cb"                , ''                          ]
        Param["htc_wb"                ]=[ f'{htc_wb      :.2f}'  , '[W/(m^2 K)]'  , "htc_wb"                , "heat-transfer-coefficient" ]
        Param["htc_ta"                ]=[ f'{htc_ta      :.2f}'  , '[W/(m^2 K)]'  , "htc_ta"                , "heat-transfer-coefficient" ]
        Param["htc_tb"                ]=[ f'{htc_tb      :.2f}'  , '[W/(m^2 K)]'  , "htc_tb"                , "heat-transfer-coefficient" ]
        Param["h_wl"                  ]=[ f'{h_wl        :.4f}'  , '[W/(m^2 K)]'  , "h_wl"                  , "heat-transfer-coefficient" ]
        Param["h_wr"                  ]=[ f'{h_wr        :.4f}'  , '[W/(m^2 K)]'  , "h_wr"                  , "heat-transfer-coefficient" ]
        Param["h_wt"                  ]=[ f'{h_wt        :.4f}'  , '[W/(m^2 K)]'  , "h_wt"                  , "heat-transfer-coefficient" ]
        Param["h_wb"                  ]=[ f'{h_wb        :.4f}'  , '[W/(m^2 K)]'  , "h_wb"                  , "heat-transfer-coefficient" ]
        Param["h_wf"                  ]=[ f'{h_wf        :.4f}'  , '[W/(m^2 K)]'  , "h_wf"                  , "heat-transfer-coefficient" ]
        Param["h_cv"                  ]=[ f'{h_cv        :.4f}'  , '[W/(m^2 K)]'  , "h_cv"                  , "heat-transfer-coefficient" ]
        Param["h_cd"                  ]=[ f'{h_cd        :.4f}'  , '[W/(m^2 K)]'  , "h_cd"                  , "heat-transfer-coefficient" ]
        Param["h_vo"                  ]=[ f'{h_vo        :.4f}'  , '[W/(m^2 K)]'  , "h_vo"                  , "heat-transfer-coefficient" ]
        Param["h_vw"                  ]=[ f'{h_vw        :.4f}'  , '[W/(m^2 K)]'  , "h_vw"                  , "heat-transfer-coefficient" ]
        Param["h_fi"                  ]=[ f'{h_fi        :.4f}'  , '[W/(m^2 K)]'  , "h_fi"                  , "heat-transfer-coefficient" ]
        Param["l_rf"                  ]=[ f'{l_rf        :.4f}'  , '[W/(m K)]'    , "l_rf"                  , ""                          ]
        Param["ctt"                   ]=[ f'{ctt         :.2f}'  , ''             , "ctt"                   , ''                          ]
        Param["temp_water"            ]=[ f'{temp_water  :.0f}'  , '[K]'          , "temp_water"            , "temperature"	              ]
        Param["temp_ext"              ]=[ f'{temp_ext    :.0f}'  , '[K]'          , "temp_ext"              , "temperature"	              ]
        # Param["temp_tal"              ]=[ "ctt*temp_water+(1-ctt)*T_tb" , ""      , "temp_tal"              , "temperature"	              ]
    else :
        Param["hrr"                   ]=[ 'HeatofReaction/CellVolume' , ''        , "hrr"                   , ''                          ]  
